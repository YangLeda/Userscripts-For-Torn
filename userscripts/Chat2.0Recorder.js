...
(function () {
  ...
  function initIndexDB() {
    const openRequest = indexedDB.open("scriptChat2.0RecorderDB", 1);
    openRequest.onupgradeneeded = function (e) {
      ...
      if (!db.objectStoreNames.contains("messageStore")) {
        ...
        const objectStore = db.createObjectStore("messageStore", { autoIncrement: true });
  ...
  function dbWrite(message) {
    ...
    transaction.oncomplete = (event) => {
      //console.log("ChatRecorder: dbWrite transaction oncomplete [" + msg.targetPlayerId + " " + msg.senderName + ": " + msg.messageText + "]");
    };
